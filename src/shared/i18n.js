...
var GT_I18N = {
  ko: {
    ...
    'opt.skin.label': '스킨',
    'opt.skin.help': 'ChatGPT 위에 씌울 화면의 종류입니다. 바꾸면 열려 있는 ChatGPT 탭에 바로 적용됩니다. 노 스킨은 원본 화면을 그대로 두고 Ctrl+; 로 명령줄만 엽니다.',
  ...
  en: {
    ...
    'opt.skin.label': 'Skin',
    'opt.skin.help': 'Which interface to lay over ChatGPT. Changes apply to open ChatGPT tabs right away. No skin keeps the original screen and opens only a command line with Ctrl+;.',
