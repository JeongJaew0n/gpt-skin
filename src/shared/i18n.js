...
var GT_I18N = {
  ko: {
    ...
    'cmd.skin.switched': '$1 스킨으로 바꿨습니다',
    'none.placeholder': ':help 로 명령 목록 · esc 로 닫기',
    'cmd.skin.failed': '$1 스킨으로 바꾸지 못했습니다: $2',
    'cmd.hidden': '$1 은 $2 스킨에서는 쓸 수 없는 명령입니다',
  ...
  en: {
    ...
    'cmd.skin.switched': 'Switched to the $1 skin',
    'none.placeholder': ':help for commands · esc to close',
    'cmd.skin.failed': 'Could not switch to the $1 skin: $2',
    'cmd.hidden': '$1 is not available in the $2 skin',
