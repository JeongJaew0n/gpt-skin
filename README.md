...
![테스트 1434](https://img.shields.io/badge/테스트-1434_케이스-22C55E)
...
<details>
<summary><b>40개 파일 · 1434 케이스</b></summary>
...
| `sheet` | 71 | 시트 스킨 — 한 행에 한 줄 · 스트리밍 중 두 행만 다시 · 인용 번호가 행을 건너 이어지는가 · 셀 선택·방향키·복사 · 입력 미러 · 시트 탭 |
...
| [스킨 구조 — terminal · sheet · none 을 갈아끼운다](docs/plan/2026-09-24-skin-architecture.md) | 1~8단계 구현 (0.4.2~0.8.0) — terminal · sheet · none 스킨, 실시간 전환 |
